...
var app = (function () {
    ...
    /* src/MainScreen.svelte generated by Svelte v3.24.1 */

    const { Object: Object_1, console: console_1 } = globals;
    const file = "src/MainScreen.svelte";
    ...
    // (56:0) {#each [...repos] as [name, commits]}
    function create_each_block_1(ctx) {
    	let p;
    	let t0_value = /*name*/ ctx[9] + "";
    	let t0;
    	let t1;
    	let t2_value = /*commits*/ ctx[10].length + "";
    	let t2;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*repos*/ 1 && t0_value !== (t0_value = /*name*/ ctx[9] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*repos*/ 1 && t2_value !== (t2_value = /*commits*/ ctx[10].length + "")) set_data_dev(t2, t2_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:0) {#each [...repos] as [name, commits]}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*re*/ 2 && t_value !== (t_value = /*r*/ ctx[6].Time + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each1_anchor = empty();
    			add_location(button, file, 51, 0, 1277);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*loadData*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*repos*/ 1) {
    				each_value_1 = [.../*repos*/ ctx[0]];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<MainScreen> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("loadData" in $$props) $$invalidate(2, loadData = $$props.loadData);
    		if ("setDevices" in $$props) setDevices = $$props.setDevices;
    		if ("setRepos" in $$props) setRepos = $$props.setRepos;
    		if ("re" in $$props) $$invalidate(1, re = $$props.re);
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = `${Date()}`;
    			add_location(p, file$1, 28, 2, 398);
