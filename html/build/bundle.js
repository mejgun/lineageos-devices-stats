...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 16, 6, 371);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(16:4) {#if dev.lineage_recovery}",
    		ctx
    	});
    ...
    // (24:4) {#each [...dev.Repos] as [name, repo]}
    function create_each_block(ctx) {
    	let a;
    	let div1;
    	let div0;
    	let t0_value = /*repo*/ ctx[2].authorsCount + "";
    	let t0;
    	let t1;
    	let t2_value = /*repo*/ ctx[2].committersCount + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 28, 10, 760);
    			attr_dev(div1, "class", "progress");
    			attr_dev(div1, "title", div1_title_value = "" + (/*name*/ ctx[1] + " (" + /*repo*/ ctx[2].health + "%) " + /*repo*/ ctx[2].authorsCount + " (" + /*repo*/ ctx[2].committersCount + ")"));
    			add_location(div1, file$1, 25, 8, 630);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", a_href_value = "https://github.com/LineageOS/" + /*name*/ ctx[1]);
    			add_location(a, file$1, 24, 6, 559);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*dev*/ 1 && t0_value !== (t0_value = /*repo*/ ctx[2].authorsCount + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*dev*/ 1 && t2_value !== (t2_value = /*repo*/ ctx[2].committersCount + "")) set_data_dev(t2, t2_value);
    			...
    			if (dirty & /*dev*/ 1 && div1_title_value !== (div1_title_value = "" + (/*name*/ ctx[1] + " (" + /*repo*/ ctx[2].health + "%) " + /*repo*/ ctx[2].authorsCount + " (" + /*repo*/ ctx[2].committersCount + ")"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:4) {#each [...dev.Repos] as [name, repo]}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", a0_href_value = "https://wiki.lineageos.org/devices/" + /*dev*/ ctx[0].Model);
    			add_location(a0, file$1, 7, 4, 99);
    			add_location(td0, file$1, 6, 2, 90);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", a1_href_value = "https://download.lineageos.org/" + /*dev*/ ctx[0].Model);
    			add_location(a1, file$1, 12, 4, 219);
    			add_location(td1, file$1, 11, 2, 210);
    			add_location(td2, file$1, 19, 2, 438);
    			add_location(td3, file$1, 20, 2, 462);
    			add_location(td4, file$1, 21, 2, 483);
    			add_location(td5, file$1, 22, 2, 505);
    			add_location(td6, file$1, 41, 2, 1107);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*dev*/ 1 && a0_href_value !== (a0_href_value = "https://wiki.lineageos.org/devices/" + /*dev*/ ctx[0].Model)) {
    			...
    			if (!current || dirty & /*dev*/ 1 && a1_href_value !== (a1_href_value = "https://download.lineageos.org/" + /*dev*/ ctx[0].Model)) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*filtered*/ 1) device_changes.dev = /*dev*/ ctx[7];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(26:4) {#each [...filtered] as [, dev]}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function filters_1_value_binding(value) {
    		/*filters_1_value_binding*/ ctx[5].call(null, value);
    	}

    	let filters_1_props = {
    		branches: calculateBranches(/*devices*/ ctx[2]),
    		oems: calculateOems(/*devices*/ ctx[2])
    	};
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file$3, 24, 2, 724);
    			attr_dev(table, "class", "table table-dark");
    			add_location(table, file$3, 19, 0, 574);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("deviceList" in $$props) $$invalidate(3, deviceList = $$props.deviceList);
    		if ("repoList" in $$props) $$invalidate(4, repoList = $$props.repoList);
    	};
    	...
    	return [filtered, filters, devices, deviceList, repoList, filters_1_value_binding];
    }

    class DeviceList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { deviceList: 3, repoList: 4 });
    		...
    		if (/*deviceList*/ ctx[3] === undefined && !("deviceList" in props)) {
    			console_1.warn("<DeviceList> was created without expected prop 'deviceList'");
    		}

    		if (/*repoList*/ ctx[4] === undefined && !("repoList" in props)) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 45, 6, 919);
    			add_location(p, file$4, 52, 6, 1077);
    			attr_dev(div, "class", "container");
    			add_location(div, file$4, 44, 4, 889);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	let a;
    	let current;
    	let if_block0 = /*alerts*/ ctx[4] && create_if_block_1$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 56, 4, 1122);
    			add_location(p, file$4, 55, 2, 1114);
