...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 26, 10, 653);
    			attr_dev(div1, "class", "progress");
    			attr_dev(div1, "title", div1_title_value = "" + (/*name*/ ctx[1] + " (" + /*repo*/ ctx[2].health + "%) " + /*repo*/ ctx[2].committersCount));
    			add_location(div1, file$1, 23, 8, 545);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", a_href_value = "https://github.com/LineageOS/" + /*name*/ ctx[1]);
    			add_location(a, file$1, 22, 6, 474);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*dev*/ 1 && div1_title_value !== (div1_title_value = "" + (/*name*/ ctx[1] + " (" + /*repo*/ ctx[2].health + "%) " + /*repo*/ ctx[2].committersCount))) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td6, file$1, 39, 2, 978);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 5, 2, 59);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [value, input_change_handler];
    }
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:4) {#each [...filtered] as [, dev]}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function filters_1_value_binding(value) {
    		/*filters_1_value_binding*/ ctx[4].call(null, value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$3, 23, 6, 570);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$3, 24, 6, 602);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$3, 25, 6, 635);
    			attr_dev(th3, "scope", "col");
    			add_location(th3, file$3, 26, 6, 669);
    			attr_dev(th4, "scope", "col");
    			add_location(th4, file$3, 27, 6, 700);
    			set_style(th5, "width", "200px");
    			attr_dev(th5, "scope", "col");
    			add_location(th5, file$3, 28, 6, 733);
    			add_location(tr, file$3, 22, 4, 559);
    			add_location(thead, file$3, 21, 2, 547);
    			add_location(tbody, file$3, 31, 2, 805);
    			attr_dev(table, "class", "table table-dark");
    			add_location(table, file$3, 20, 0, 512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("deviceList" in $$props) $$invalidate(2, deviceList = $$props.deviceList);
    		if ("repoList" in $$props) $$invalidate(3, repoList = $$props.repoList);
    	};
    	...
    	return [filtered, filters, deviceList, repoList, filters_1_value_binding];
    }

    class DeviceList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { deviceList: 2, repoList: 3 });
    		...
    		if (/*deviceList*/ ctx[2] === undefined && !("deviceList" in props)) {
    			console_1.warn("<DeviceList> was created without expected prop 'deviceList'");
    		}

    		if (/*repoList*/ ctx[3] === undefined && !("repoList" in props)) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 29, 6, 634);
    			add_location(p, file$4, 36, 6, 792);
    			attr_dev(div, "class", "container");
    			add_location(div, file$4, 28, 4, 604);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$4, 24, 0, 511);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
